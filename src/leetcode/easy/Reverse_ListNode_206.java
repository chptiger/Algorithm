...
public class Reverse_ListNode_206{
	...
	/*
	To reverse this head, we need 3 additional pointers. 
	currentNode pointer to traverse through the head;
	nextNode pointer to save the next node in the head;
	prevNode pointer to keep track of the last node in the new head as we keep on reversing the input head. 
	So, in essence, here is the pseudo algorithm to reverse the head:
	
	Initialize currentNode pointer to the start of the head and prevNode to NULL (as the new head is currently pointing to NULL).
