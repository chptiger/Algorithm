 ...
 * in ascending order, both min and max are inclusive. Examples 5 / \ 3 8 / \ \
 * 1 4 11
 * 
 * get the keys in [2, 5] in ascending order, result is [3, 4, 5]
 * 
 * Corner Cases What if there are no keys in the given range? Return an empty
 * list in this case.
 * 
 * How is the binary tree represented? We use the level order traversal sequence
...
public class GetKeysInBinarySearchTreeInGivenRange_31 {
	 ...
	 */
	public static List<Integer> getKeysInBinarySearchTree(TreeNode root, int min, int max, List<Integer> result) {
		if (root == null) {
			return null;
		}
		if (root.key > min) {
