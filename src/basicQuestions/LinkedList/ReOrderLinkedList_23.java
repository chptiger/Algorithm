 ...
 * to be N1- > Nn -> N2 -> Nn-1 -> N3 -> Nn-2 -> �� -> null Examples L = null,
 * is reordered to null L = 1 -> null, is reordered to 1 -> null L = 1 -> 2 -> 3
 * -> 4 -> null, is reordered to 1 -> 4 -> 2 -> 3 -> null L = 1 -> 2 -> 3 ->
 * null, is reordred to 1 -> 3 -> 2 -> null
 * 
 * @author Thomas
 *
 */
public class ReOrderLinkedList_23 {
	...
	public static ListNode reOrderLinkedList(ListNode head) {
		...
		// why the midNode.next is updated, secondHalf will not be updated? Compare with
		// line 73
