...
/**
 * remove all leading/trailing and duplicate empty spaces(only have one empty
 * space if duplicated spaces happen) from the input string
 * 
 * 
 * _ _ _abc _ _ ed_ _ ef_ _ abc_ed_ef
 * 
 * @author eng_1
 *
 */
