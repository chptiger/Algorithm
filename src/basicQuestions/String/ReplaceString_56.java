 ...
 * occurrences of S in input with T. Assumptions input, S and T are not null, S
 * is not empty string
 * 
 * Examples
 * 
 ...
 * 
 * input = "https://www.google.com?q=thomas_test", S = "_", T = "20%", input
 * becomes "https://www.google.com?q=thomas20%test"
 *
 */
public class ReplaceString_56 {
	@Test
	public void testReplacingString() {
		assertEquals("https://www.google.com?q=thomas20%test",
				replaceString("https://www.google.com?q=thomas_test", "_", "20%"));
	...
	/*
	 * "a" replaced by "cat" In this case, we need from right-hand side to left-hand
	 * side by two pointers method If we do it from left-hand side to right-hand
	 * side, when we replace the first short string to longer string, the fast
	 * pointer will be overwritten. If we do it from right-hand side to left-hand
	 * side, we have new declared space to save the longer string and the original
	 * string will not be overwritten
	 * 
