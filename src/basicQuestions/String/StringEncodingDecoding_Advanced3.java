 ...
 * a0a1a2 a3a4a5
 * 
 * Assumption: duplicate less than 10, we could consider two digits every time.
 * 
 * explanation:
...
public class StringEncodingDecoding_Advanced3 {
	...
	public void test_decompressingString() {
		/*
		 * in place method when we say in place, it usually means the input is a long
		 * enough char array and the original string only occupies part of the array
		 * starting from index 0 and usually the length to represent the original string
		 * is given
		 */
	...
	/*
	 * We will scan the String in 2 rounds. The first round is from left-hand side
	 * to right-hand side to handle the shorter decode, ex. a0b1c2 the second round
	 * is from right-hand side to left-hand side to handle the longer decoding, ex.
	 * a3b4d5
	 */
	...
	/*
	 * handle aac3d4e5 scan the array from right-hand side to left-hand side
	 */
	...
	/*
	 * handle a3b2c3d0 scan the array from left-hand side to right-hand side
	 */
	...
	public String decompress2(String input) {
		...
		// in 2 pass to avoid conflict, since the encoding of the 2 cases require
