...
Try to do it in place: we could not use Set. because Set interface doesn't provide any ordering guarantees.
...
public class RemoveAdjacentRepeatedCharactersI_51 {
	...
	/*
	O(n)
	fast is the fast/current index to scan the string(from left to right)
	slow is the slow/index, all letters to the left of slow including(slow) should be in the final answer
	*/
