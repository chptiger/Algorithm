 ...
 * and Blue is denoted by 1). Examples {0} is sorted to {0} {1, 0} is sorted to
 * {0, 1} {1, 0, 1, -1, 0} is sorted to {-1, 0, 0, 1, 1} Assumptions The input
 * array is not null. Corner Cases What if the input array is of length zero? In
 * this case, we should not do anything as well.
 * 
 * @author Thomas
 *
 */
