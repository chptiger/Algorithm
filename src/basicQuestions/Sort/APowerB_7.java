 ...
 * non-negative. Examples power(2, 0) = 1 power(2, 3) = 8 power(0, 10) = 0
 * power(-2, 5) = -32 Corner Cases What if the result is overflowed? We can
...
public class APowerB_7 {
	...
	/*
	 * public static long powerN (int a, int b) { if ( b == 0) return 1; return
	 * a*powerN(a, b-1); }
	 */

	// something like a⁹ will be a4.5⨯a4.5. But we are talking about integer powers
	// here. Handling fractions is a whole different thing. Luckily, we can just
	// formulate that as a⨯a⁴⨯a⁴.
