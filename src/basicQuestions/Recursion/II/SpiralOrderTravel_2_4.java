...
public class SpiralOrderTravel_2_4 {
	...
	public void test_Spiral() {
		Assert.assertEquals(new ArrayList<>(Arrays.asList(1, 2, 3, 4, 5, 6, 7, 8, 9)),
				spiral(new int[][] { { 1, 2, 3 }, { 8, 9, 4 }, { 7, 6, 5 } }));
	...
	/*
	 * offset: the current level of recursion, from 0 to matrix.size / 2 size: size
	 * = size - 2, the first one and last one for every row and column separately.
	 * the spiral order traverse
	 */
