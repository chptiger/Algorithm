...
/**
 * When I use the method input.toCharArray() to pass the char[] to the swap
 * method.
 * 
 * The updated is only in the swap(), and could not get the updated input in the
 * reverse().
 * 
 * Reason: A new character array was created by this method. The updating is for
 * the new character array, not for the original String. toCharArray() Converts
