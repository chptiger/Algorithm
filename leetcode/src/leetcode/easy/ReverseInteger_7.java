...
public class ReverseInteger_7{
	...
	//																				1,534,236,469   input
	// runtime error   Line 13: java.lang.NumberFormatException: For input string: "9,646,324,351"  output
	...
	public static int ReverseInteger(int x) {
        ...
        if( m >= 0) return Integer.parseInt(result);// Line 21: java.lang.NumberFormatException: For input string: "9,646,324,351"
        else return Integer.parseInt("-1"+result);
    }
}